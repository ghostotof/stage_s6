...
def initialiser(largeur_, hauteur_, taille):
    #########################################################################
    "Initialise la fenêtre avec un rectangle de pixels"
    #########################################################################
    global _can
    global _img
    global _fen
...
def couleur(r = None, g = None, b = None):
    #########################################################################
    "Choix de la couleur du dessin (par défault = cyclique)"
    #########################################################################
    global _r
    global _g
    global _b
...
def afficher(pause = None):
    #########################################################################
    "Affiche les modifications, et fait éventuellement une pause"
    #########################################################################
    if pause == None:
