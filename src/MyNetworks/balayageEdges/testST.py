...
c1_c2.load_connectivity('./saveConnec_c2.spc')
wn = []
with open('myWeights_c2.spw', 'rb') as fichier:
...
c2_c3.load_connectivity('./saveConnec_c3.spc')
wn = []
with open('myWeights_c3.spw', 'rb') as fichier:
    mon_depick = pickle.Unpickler(fichier)
    wn = mon_depick.load()
